...
import 'package:flutter_movie_app/riverpod/provider/text_state.dart';
...
class _SearchViewState extends State<SearchView> {
  ...
  // var formatter = number('dd-MM-yyyy');
    ...
    return Scaffold(
        ...
        body: Consumer(
          builder: (context, ref, child) {
            ...
            final txt = ref.read(isText.notifier).txt;
            int page = 1;
